...
let student = {
    // key: value pairs which are comma spaced
    fName: "Connor",
    lName: "Hughes",
    address: "123 Main St",
    isEnrolled: true,
...
student.balanceOwed = 0 // property reasignment
console.log(student.balanceOwed)
student.address = "1688 House Dr" //property reassignment
console.log(student)
...
console.log(`${manager.name} to ${manager.reportsTO[2]}`)
console.log(`This manager cares for ${manager.caresFor.trainees}`)

manager.caresFor.learnA.splice(0, 0, "Jonathan")
console.log(manager)
...
let youngerPres = presidents.filter(president => president.year >= 1900)
console.log(youngerPres)

// with your new filtered array, utilize forEach method and print me a string of interpolated names of those presidents

youngerPres.forEach(({first, last}) => console.log(`${first} ${last}`)) // already inside the object

// youngerPres.forEach(pres => console.log(`${pres.first} ${pres.last}`)) // outside the object
